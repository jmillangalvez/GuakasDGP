...
class EducatorAssignedTasksList extends Component {
    ...
    return (
      <View style={{flex: 1}}>
        <SafeAreaView style={styles.banner}>
          <Text style={styles.headerText} value="EducatorAssignedTasksList" accessibilityRole="header">Selecciona un estudiante</Text>
        </SafeAreaView>
          ...
          renderItem = {({item}) => {
            return(
              <View style={styles.listContainer}>
                <TouchableOpacity onPress={() => this.props.navigation.navigate('EducatorAssignedTasks', {idStudent: item.idStudent})}>
...
export default EducatorAssignedTasksList;