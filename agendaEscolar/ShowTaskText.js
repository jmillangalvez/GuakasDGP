...
function taskText({navigation}) {
  changeScreenOrientation();
  return (
    <View style={styles.container}>
      {/*Title and description of the task*/}
      <View style={styles.box}> 
        <Text style={styles.headerText}>Ir a comer
        </Text>
        <Text style={styles.infoText}>Ir al comedor, buscar el asiento y sentarte a comer
        </Text>
      </View>
      
      {/*Go to endTask (Boceto 20)*/}
      <View style={styles.arrowContainer}>
        <TouchableOpacity style={{alignSelf: "center"}} onPress={() => navigation.navigate('taskEnd')}>
          <Image source={require('./img/arrowRight.png')} style={styles.img}/>
        </TouchableOpacity>
      </View>
      
      {/*Bottom banner to go to daily task screen (Boceto 18)*/}
...
function taskEnd({navigation}) {
   changeScreenOrientation();
   return (
    <View style={styles.container}>
      {/*Go to prev screen (Boceto 19)*/}
      <View style={styles.arrowContainer}>
        <TouchableOpacity style={{alignSelf: "center"}} onPress={() => navigation.navigate('taskText')}>
